...
class AISkillsAudit {
    ...
    loadFallbackQuestions() {
        ...
        this.questions = [
            {
                id: 'businessUnit',
                question: 'Which Randstad GBS business function best describes your role?',
                type: 'single',
                showIf: null,
    ...
    calculateResults() {
        ...
        switch (businessUnit) {
            ...
            default:
                totalTimeSaved = 5;
                activities = [
                    { name: 'General AI Tools', hours: 5, savings: 2, tools: ['ChatGPT', 'Microsoft Copilot'], priority: 'medium' }
                ];
        }
        ...
        const pdfContent = `
            ...
            <body>
                ...
                <div style="margin-top: 40px; text-align: center; color: #6B7280; font-size: 12px;">
                    <p>Generated by Randstad GBS AI Skills Audit</p>
